  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 h-full flex flex-col transition-colors duration-300">
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-bold text-lg text-gray-900 dark:text-white">{t('dashboard.task_distribution')}</h3>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Dev</span>
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Marketing</span>
        </div>
      </div>
      ...
      <div className="flex-1 w-full min-h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} barSize={12}>
            ...
            />
            <Bar dataKey="value1" stackId="a" fill="#BFDBFE" radius={[0, 0, 0, 0]} name="Dev" />
            <Bar dataKey="value2" stackId="a" fill="#60A5FA" radius={[0, 0, 0, 0]} name="Design" />
            <Bar dataKey="value3" stackId="a" fill="#2563EB" radius={[4, 4, 0, 0]} name="Marketing" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
